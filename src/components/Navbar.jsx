    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-7">
          <a href="/#features" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors duration-150">Features</a>
          <a href="/#features" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors duration-150">Solutions</a>
          <a href="/#cta" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors duration-150">Pricing</a>
          <a href="/#cta" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors duration-150">Customers</a>
          <a href="/#cta" className="text-sm font-medium text-text-secondary hover:text-primary transition-colors duration-150">About</a>
        </div>
        ...
        <div className="hidden sm:flex items-center gap-4">
          {isLoggedIn ? (
            ...
            <>
              <Link
                to="/login"
                className="text-sm font-medium text-text-secondary hover:text-primary transition-colors duration-150 px-3 py-2"
              >
                Login
              </Link>
              <Link
                to="/login"
                className="text-sm font-semibold text-white px-4 py-2 rounded-full shadow-sm transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                style={{ backgroundColor: '#C96C2B', boxShadow: '0 2px 10px rgba(201,108,43,0.28)' }}
                onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 4px 16px rgba(201,108,43,0.38)'; }}
                onMouseLeave={e => { e.currentTarget.style.boxShadow = '0 2px 10px rgba(201,108,43,0.28)'; }}
              >
                Get Started
              </Link>
            </>
